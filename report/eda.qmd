...
Here we ompare and visualize specific vehicle fuel types between Swiss and French datasets.
...
ggplot() +
  ...
  theme_minimal() +
  geom_text(data = data.frame(x = as.Date("2021-01-01"), y = c(3, 2.5), label = c("Switzerland has", "the thickest line")), 

...
### Cleaning of google_trends_data
```{r}
...
### Cleaning of parc_vp_france_2022.xlsx
...
We will only keep the vehicles used for personnal use (not the ones for professional use), to match our Swiss dataset
